  ...
  if(date("Y-m-d",$appdate1)>=$cur_date){
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        //   "insert into appointmenttb(pid,doctor,docFees,appdate,apptime,userStatus,doctorStatus) values($pid,'$doctor','$docFees','$appdate','$apptime','1','1')"
          
        if(mysqli_num_rows($check_query) == 0) {
          // ID should be auto incremented
          $query = mysqli_query($con, "INSERT INTO appointmenttb (pid, doctor, docFees, appdate, apptime, userStatus, doctorStatus) 
                                      VALUES ('$pid', '$doctor', '$docFees', '$appdate', '$apptime', '1', '1')");
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Book Appointmentawseyruirc</h4></center><br>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    global $con;
                    //issue resolved
                    // $query = "SELECT ID, doctor, docFees, appdate, apptime, userStatus, doctorStatus FROM appointmenttb WHERE pid IN ( SELECT pid FROM prestb where fname ='$fname' and lname='$lname');";
                    $query = "SELECT ID, doctor, docFees, appdate, apptime, userStatus, doctorStatus FROM appointmenttb WHERE pid IN (SELECT pid FROM `patreg` WHERE fname ='$fname' and lname='$lname');";
