...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
  ...
  $query=mysqli_query($con,"insert into prestb(doctor,pid,appdate,apptime,disease,allergy,prescription) values ('$doctor','$pid','$appdate','$apptime','$disease','$allergy','$prescription')");
